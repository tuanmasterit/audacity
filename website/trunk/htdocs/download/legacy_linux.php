...
<p><?=_('The above list is not comprehensive. If you don\'t see an up-to-date package for your own distribution, we recommend searching your distribution\'s website for the latest information. Alternatively, you can compile Audacity from <a href="legacy_source">source code</a>.')?></p>
