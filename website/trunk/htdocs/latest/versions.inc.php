...
define('macosx_version', '2.1.1');
define('macosx_size',    35.28);
define('macosx_zip_size',   16.32);

define('win_exe_version', '2.1.1');
define('win_exe_size',    24.02);
define('win_zip_version', '2.1.1');
define('win_zip_size',    8.79);


define('ladspa_version', '0.4.15');
define('ladspa_size',    1.44);

define('src_version', '2.1.1');
/*define('full_src_size',    18.2);*/
define('min_src_size',    6.82);
