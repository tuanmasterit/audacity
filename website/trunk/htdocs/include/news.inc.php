...
<p>
  <ul>
    ...
    <li>Over 50 bugs have been addressed with this release.  Audacity now works faster with longer projects, audio of about 2 hours duration, than it did before.</li>
...
<p>
  <ul>
    ...
    <li>Lots of other improvements to effects, also thanks to Leland, including: 
      <ul>
        <li>VST: FXB preset banks, hosting multiple plug-ins</li>
...
See the <a href=\"http://wiki.audacityteam.org/wiki/Release_Notes_2.1.0\">2.1.0 Release Notes</a> 
for details. 
</p>
